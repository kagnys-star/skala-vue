 ...
 *
 * 개수를 5개로 맞춘 이유:
 * 무료 플랜은 분당 5회, 하루 25회로 제한된다. 종목 수만큼 호출이 나가므로
 * 6개를 두면 매번 한 종목은 반드시 실패한다. (실제로 6개일 때 2개가 빠졌다)
 * 딱 5개로 맞추면 한 번에 전부 채울 수 있고, 하루 다섯 번까지 갱신할 수 있다.
 *
 * 받아온 값은 스토어에서 저장해 두고 재사용하므로 화면을 여닫는 것만으로는 호출되지 않는다.
 */
